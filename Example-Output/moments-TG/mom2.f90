...
! OPS  13*MUL = 13  (32 before optimization)
...
! OPS  18*ADD + 22*MUL = 40  (59 before optimization)
...
#define M_zz                 M(9)
    ...
    Ms_y  = M_y + v1
    Ms_z  = M_0*z + M_z
    Ms_xy = M_xy + M_x*y + M_y*x + v0*y
    Ms_xz = M_xz + M_x*z + M_z*x + v0*z
    Ms_yz = M_yz + M_y*z + M_z*y + v1*z
    c1    = z
    b1    = y
    a1    = x
    a2    = a1*a1
    v3    = a2
    Ms_xx = M_xx + M_x*x + v2*v3
    b2    = b1*b1
    v4    = b2
    Ms_yy = M_yy + M_y*y + v2*v4
    c2    = c1*c1
    v5    = c2
    Ms_zz = M_zz + M_z*z + v2*v5
#undef  x                   
#undef  y                   
#undef  z                   
#undef  Ms_0                
...
! OPS  22*ADD + 2*DIV + 46*MUL + 5*NEG + POW = 76  (96 before optimization)
...
#define M_zz                 M(9)
    ...
    Ms_y  = Ms_y + (M_y + v1)
    Ms_z  = Ms_z + (M_0*z + M_z)
    Ms_xy = Ms_xy + (M_xy + M_x*y + M_y*x + v0*y)
    Ms_xz = Ms_xz + (M_xz + M_x*z + M_z*x + v0*z)
    Ms_yz = Ms_yz + (M_yz + M_y*z + M_z*y + v1*z)
    c1    = z
    b1    = y
    a1    = x
    a2    = a1*a1
    v3    = a2
    Ms_xx = Ms_xx + (M_xx + M_x*x + v2*v3)
    b2    = b1*b1
    v4    = b2
    Ms_yy = Ms_yy + (M_yy + M_y*y + v2*v4)
    c2    = c1*c1
    v5    = c2
    Ms_zz = Ms_zz + (M_zz + M_z*z + v2*v5)
#undef  x                   
#undef  y                   
#undef  z                   
#undef  Ms_0                
